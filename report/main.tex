...
Das primäre Ziel dieses Projekts ist die Entwicklung eines 2D-Dungeon-Crawlers mit integrierten Autobattler-Kampfmechaniken. Die Software soll es dem Spieler ermöglichen, einen Charakter über eine zweidimensionale, in Felder unterteilte Karte zu bewegen, auf der sich Hindernisse, reguläre Gegner und mindestens ein Bossgegner befinden.

Um die grundlegenden Projektanforderungen (Erfolgskriterien) zu erfüllen, muss am Ende ein vollständig spielbarer Durchlauf (Run) gewährleistet sein. Diese Minimalanforderung umfasst konkret:
\begin{itemize}
